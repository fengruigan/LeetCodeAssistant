...
const SEARCH_BAR_MIN_VALUE = document.querySelector("#ratingLowerbound").attributes.getNamedItem('min').value
const SEARCH_BAR_MAX_VALUE = document.querySelector("#ratingLowerbound").attributes.getNamedItem('max').value

const clampNumber = (upperbound, lowerbound, value) => {
...
const handleInputChange = (element, event) => {
    ...
    element.value = clampNumber(SEARCH_BAR_MAX_VALUE, SEARCH_BAR_MIN_VALUE, event.target.value)
}
